...
//yangjq, 20131218, Use reserved share memory to communicate with modem/adsp/wcnss
	...
	if (!error) {
		*wakeup = pm_wakeup_pending();
		if (!(suspend_test(TEST_CORE) || *wakeup)) {
			//yangjq, 20131218, Inform modem/adsp/wcnss apps is power collapsed
			smem_set_reserved(6, smem_get_reserved(6) | 0x80000000);
			error = suspend_ops->enter(state);
			//yangjq, 20131218, Inform modem/adsp/wcnss apps is power restored
			smem_set_reserved(6, smem_get_reserved(6) & ~0x80000000);
