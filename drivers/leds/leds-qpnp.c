...
#include <linux/delay.h>
/*Begin lenovo-sw wengjun1 add for close keypad led control while chargeoff mode. 2014-9-15*/
#include <soc/qcom/socinfo.h>
/*End lenovo-sw wengjun1 add for close keypad led control while chargeoff mode. 2014-9-15*/
...
{    
	printk("[wj]name=%s.\n", str);
	if(!strncmp(str,"usb_cable",12))
	{
	    printk("[wj]chargeoff usb_cable plug in.\n");
	    parse_mode = 1;
	}
